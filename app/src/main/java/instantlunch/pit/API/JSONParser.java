...
public class JSONParser {
    ...
    public JSONObject makeHttpPostRequest(String url, JSONObject jsonBody) {
        ...
        try {
            ...
            paramsString = jsonBody.toString();
    ...
    public JSONObject makeHttpGetAuthRequest(String url, String userToken) {
